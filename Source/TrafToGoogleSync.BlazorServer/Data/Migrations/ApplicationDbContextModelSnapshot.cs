...
#pragma warning disable 612, 618
			...
			modelBuilder.Entity(
				"TrafToGoogleSync.BlazorServer.Data.ApplicationUser",
				b =>
				{
					b
						.Property<string>("Id")
			...
			modelBuilder.Entity(
				...
				{
					b
						.HasOne("TrafToGoogleSync.BlazorServer.Data.ApplicationUser", null)
						.WithMany()
			...
			modelBuilder.Entity(
				...
				b =>
				{
					...
					b.OwnsOne(
						...
						{
							b1
								.Property<byte[]>("IdentityUserPasskeyCredentialId")
								.HasColumnType("BLOB");

							b1
								.Property<byte[]>("AttestationObject")
								.IsRequired()
								.HasColumnType("BLOB");

							b1
								.Property<byte[]>("ClientDataJson")
								.IsRequired()
								.HasColumnType("BLOB");
							...
							b1
								.Property<bool>("IsBackedUp")
								.HasColumnType("INTEGER");

							b1
								.Property<bool>("IsBackupEligible")
								.HasColumnType("INTEGER");

							b1
								.Property<bool>("IsUserVerified")
								.HasColumnType("INTEGER");
							...
							b1
								.Property<uint>("SignCount")
								.HasColumnType("INTEGER");

							b1
								.PrimitiveCollection<string>("Transports")
								.HasColumnType("TEXT");
